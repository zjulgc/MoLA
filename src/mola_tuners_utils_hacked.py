...
class BaseTuner(nn.Module, ABC):
    ...
    def __init__(self, model, peft_config: Union[PeftConfig, dict[str, PeftConfig]], adapter_name: str, number_experts: list = [8] * 32, top_k: list = [2] * 32) -> None:
        super().__init__()
    ...
    def inject_adapter(self, model: nn.Module, adapter_name: str):
        ...
        for key in key_list:
            ...
            ### implied in child class
            self._create_and_replace(peft_config, adapter_name, target, target_name, parent, current_key=key, layer_index=layer_index, number_experts=self.number_experts, top_k=self.top_k)
